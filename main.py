...
def main():
    ...
    add_parser.add_argument('--storage_type', type=str, default='memory', help='Type of storage (memory, jsonfile, sqlite)')
    ...
    get_parser.add_argument('--storage_type', type=str, default='memory', help='Type of storage (memory, jsonfile, sqlite)')
    ...
    delete_parser.add_argument('--storage_type', type=str, default='memory', help='Type of storage (memory, jsonfile, sqlite)')
    delete_parser.set_defaults(func=handle_delete_task)

    # List tasks command
    list_parser = subparsers.add_parser('list', help='List all tasks')
    list_parser.add_argument('--storage_type', type=str, default='memory', help='Type of storage (memory, jsonfile, sqlite)')
    ...
    update_parser.add_argument('--storage_type', type=str, default='memory', help='Type of storage (memory, jsonfile, sqlite)')
